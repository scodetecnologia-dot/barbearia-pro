...
import { Calendar, Clock, User, CheckCircle, ArrowLeft, Loader2 } from 'lucide-react';
...
const BookingForm: React.FC<BookingFormProps> = ({ onBack, preFilledClient }) => {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="bg-zinc-900 rounded-2xl border border-zinc-800 shadow-2xl overflow-hidden min-h-[400px]">
        {/* Progress Bar */}
        ...
        <div className="p-8">
          {isLoading ? (
            <div className="flex flex-col items-center justify-center py-12">
              <Loader2 className="w-8 h-8 text-barber-gold animate-spin mb-4" />
              <p className="text-zinc-500">Carregando disponibilidade...</p>
            </div>
          ) : (
            <>
              {step === 1 && (
